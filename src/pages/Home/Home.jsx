    ...
    return (
        <main>
           ...
           <section className={styles.features}>
                ...
                <Feature imgSrc={iconMoney} imgAlt="Money Icon" title="More savings means higher rates" description="The more you save with us, the higher your interest rate will be!" />
